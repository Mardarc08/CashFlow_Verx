...
namespace Testes.Unit
{
    public class RegistrarLancamentoHandlerTests
    {
        ...
        private readonly IPubSubPublisher _publisher = Substitute.For<IPubSubPublisher>();
        ...
        public RegistrarLancamentoHandlerTests()
        {
            ...
            _handler = new RegistrarLancamentoHandler(_repository, _publisher, _validator, _logger);
        }
        ...
        public async Task Handle_ComDadosValidos_DeveRegistrarEPublicarEvento()
        {
            ...
            await _publisher.Received(1).PublicarAsync(Arg.Any<LancamentoRegistradoEvent>(), Arg.Any<CancellationToken>());
        }
